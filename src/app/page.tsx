  ...
  return (
    <>
      <main className="max-w-[1440px] mx-auto">
        ...
        <div  className='bg-Light-Grayish-Blue px-52 py-20 font-PublicSans'>
          <div>
              <p className='text-4xl text-Dark-Blue'>Why choose Easybank?</p>
              <p className='text-Grayish-Blue mt-6 w-[60%]'>We leverage Open Banking to turn your bank account into your financial hub. Control 
          ...
          <div className='mt-16 grid grid-cols-4 gap-x-5'>
              <div>
                ...
                <p className='text-Dark-Blue text-xl mt-8'>Online Banking</p>
                <p className='text-Grayish-Blue mt-6 text-sm'>Our modern web and mobile applications allow you to keep track of your finances 
              ...
              <div>
                ...
                <p className='text-Dark-Blue text-xl mt-8'>Simple Budgeting</p>
                <p className='text-Grayish-Blue mt-6 text-sm'>See exactly where your money goes each month. Receive notifications when you’re 
              ...
              <div>
                ...
                <p className='text-Dark-Blue text-xl mt-8'>Fast Onboarding</p>
                <p className='text-Grayish-Blue mt-6 text-sm'>We don’t do branches. Open your account in minutes online and start taking control 
              ...
              <div>
                ...
                <p className='text-Dark-Blue text-xl mt-8'>Open API</p>
          ...
          <div className='mt-10 grid grid-cols-4 gap-x-6'>
            <div className='bg-white rounded-md'>
              ...
              <div className='mt-8 mb-6 mx-6'>
                ...
                <p className='my-3 text-lg text-Dark-Blue leading-5'>Receive money in any currency with no fees</p>
            ...
            <div className='bg-white rounded-md'>
              ...
              <div className='mt-8 mb-6 mx-6'>
                ...
                <p className='my-3 text-lg text-Dark-Blue leading-5'>Treat yourself without worrying about money</p>
            ...
            <div className='bg-white rounded-md'>
              ...
              <div className='mt-8 mb-6 mx-6'>
                <p className='text-xs text-Grayish-Blue'>By Wilson Hutton</p>
                <p className='my-3 text-lg text-Dark-Blue leading-5'>Take your Easybank card wherever you go</p>
            ...
            <div className='bg-white rounded-md'>
              ...
              <div className='mt-8 mb-6 mx-6'>
                <p className='text-xs text-Grayish-Blue'>By Claire Robinson</p>
                <p className='my-3 text-lg text-Dark-Blue leading-5'>Our invite-only Beta accounts are now live!</p>
        ...
        <div className='bg-Dark-Blue py-10 flex justify-between px-52'>
          ...
          <div className='text-right'>
              <button className="font-PublicSans bg-gradient-to-tr from-Lime-Green to-Bright-Cyan text-white py-3 px-8 rounded-full">Request Invite</button>
