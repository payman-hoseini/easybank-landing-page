...
export default function Hero(){
    return (
        <>
        <div className='bg-Very-Light-Gray font-PublicSans flex flex-col-reverse md:flex-row items-center md:pl-52 desBackground'>
          <div>
          ...
          <div className='custome-overflow'>
              <Image src={mockups} alt="mockups" className='md:scale-150 w-full drop-shadow-xl'/>
          </div>
        </div>
        </>
    )
