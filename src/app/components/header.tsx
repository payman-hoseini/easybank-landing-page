...
export default function Header(){
    ...
    return (
        <>
            <div className="max-w-[1024px] w-[90%] mx-auto flex justify-between items-center font-PublicSans md:pt-2 py-5">
                <div>
                ...
                <div className="space-x-7 text-Grayish-Blue hidden md:block">
                ...
                {!showMenu ? <button onClick={showMenuHandler}>
