...
export default function Header(){
    ...
    return (
        <>
            <div className="max-w-[1024px] w-[90%] mx-auto flex justify-between items-center font-PublicSans lg:pt-2 lg:py-0 py-5">
                <div>
                ...
                <div className="space-x-7 text-Grayish-Blue hidden lg:block">
                    <button className="border-b-4 border-b-transparent hover:border-b-Lime-Green hover:text-Dark-Blue py-6">Home</button>
                    <button className="border-b-4 border-b-transparent hover:border-b-Lime-Green hover:text-Dark-Blue py-6">About</button>
                    <button className="border-b-4 border-b-transparent hover:border-b-Lime-Green hover:text-Dark-Blue py-6">Contact</button>
                    <button className="border-b-4 border-b-transparent hover:border-b-Lime-Green hover:text-Dark-Blue py-6">Blog</button>
                    <button className="border-b-4 border-b-transparent hover:border-b-Lime-Green hover:text-Dark-Blue py-6">Careers</button>
                </div>
                ...
                {!showMenu ? <button className="lg:hidden flex" onClick={showMenuHandler}>
            ...
            {showMenu && <div className="fixed z-50 h-full w-full bg-gradient-to-b from-Dark-Blue to-transparent">
                <div className="bg-white w-[90%] mx-auto rounded font-PublicSans text-center mt-5 py-8 text-Dark-Blue text-lg shadow-md">
